package edu.princeton.searching;

import java.util.NoSuchElementException;

import edu.princeton.common.Queue;
...
public class BST <Key extends Comparable<Key>, Value>{
	...
	private class Node {
		...
		private int size;			//number of nodes in substree
	...
	//Returns true if number of key-value pairs in this symbol table
	private int size() {
		return size(root);
	}
	...
	public void deleteMax() {
		if (isEmpty())
			throw new NoSuchElementException("Symbol table underfolw");
		root = deleteMax(root);
		assert check();
	}
